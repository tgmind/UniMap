...
export const ThemeSelector: React.FC<ThemeSelectorProps> = ({ onClose }) => {
  ...
  return (
    <div
      className="absolute right-0 mt-2 w-72 rounded-2xl bg-surface border border-border p-2 shadow-xl z-50 animate-fade-in"
    ...
    >
      <div className="px-3 py-2 border-b border-border/70">
        ...
        <p className="text-[11px] text-text-muted">Clean, distraction-free aesthetics</p>
      </div>
          ...
          return (
            ...
            >
              <div className="flex items-center gap-3">
                {/* Visual Swatch */}
                <div
                  className="w-5 h-5 rounded-full border border-border shrink-0 flex items-center justify-center"
